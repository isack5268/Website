<div class='menu-con-message fade-out-onload'>
	<div class='menu-tx1-message toggle-message fade-out-onload'>
		<span>В настоящее время мы испытываем более высокий объем сервера, чем обычно. Приносим искренние извинения за причиненные неудобства.</span>
	</div>
</div>
...
<div class="window-con-theme">
	...
	<div class="theme-tx1-description pulsate">
		<span>Данная функция находится в разработке</span>
	</div>
...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://www.youtube.com/channel/UCoGKRH6a5x726MzbZbSgaQQ/videos' target="_blank">
			<div class="menu-btn-select">
				<span>YouTube</span>
			</div>
			</a>
